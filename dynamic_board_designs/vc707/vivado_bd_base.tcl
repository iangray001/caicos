...
#  set_property -dict [ list CONFIG.BAR0_SCALE {Gigabytes} CONFIG.BAR0_SIZE {1} CONFIG.BASE_CLASS_MENU {Processors} CONFIG.DEVICE_ID {0x7011} CONFIG.ENABLE_CLASS_CODE {false} CONFIG.M_AXI_DATA_WIDTH {128} CONFIG.NO_OF_LANES {X1} CONFIG.PCIE_CAP_SLOT_IMPLEMENTED {true} CONFIG.SUBSYSTEM_ID {0x0} CONFIG.SUBSYSTEM_VENDOR_ID {0x0} CONFIG.SUB_CLASS_INTERFACE_MENU {Co_processor} CONFIG.S_AXI_DATA_WIDTH {128} CONFIG.XLNX_REF_BOARD {VC707}  ] $axi_pcie_0
  ...
  connect_bd_net -net accel_clock [get_bd_pins axi_pcie_0/axi_aclk_out] [get_bd_pins axi_cdma_0/m_axi_aclk] [get_bd_pins pcie_mem_periph_split/S00_ACLK] [get_bd_pins mem_interconnect/M01_ACLK] [get_bd_pins mem_interconnect/S01_ACLK] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins axi_cdma_0/s_axi_lite_aclk] [get_bd_pins periph_interconnect/M03_ACLK]
  connect_bd_net -net accel_clock [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins mem_interconnect/ACLK] [get_bd_pins mem_interconnect/S00_ACLK] [get_bd_pins pcie_mem_periph_split/ACLK] [get_bd_pins pcie_mem_periph_split/M00_ACLK] 
  connect_bd_net -net accel_clock [get_bd_pins pcie_mem_periph_split/M01_ACLK] [get_bd_pins periph_interconnect/ACLK] [get_bd_pins periph_interconnect/M00_ACLK]  [get_bd_pins periph_interconnect/M02_ACLK] [get_bd_pins periph_interconnect/S00_ACLK] [get_bd_pins axi_gpio_0/s_axi_aclk]
  connect_bd_net -net accel_clock [get_bd_pins periph_interconnect/M05_ACLK] [get_bd_pins axi_intc_0/s_axi_aclk]
  ...
  connect_bd_net -net accel_resetn [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_pcie_0/axi_aresetn] [get_bd_pins axi_cdma_0/s_axi_lite_aresetn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn]
