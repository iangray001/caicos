...
typedef union jamaica_block jamaica_block;
//typedef struct jamaica_cpu jamaica_cpu;


//JBI and JNI function call modifiers are required, even though they are not used in the FPGA
/*#define JAMAICA_JNI_CALL_MODIFIERS
#define JAMAICA_JNI_IMPORT_MODIFIERS
#define JAMAICA_JNI_EXPORT_MODIFIERS
#define JAMAICA_JNI_IMPORT_EXPORT_MODIFIERS JAMAICA_JNI_IMPORT_MODIFIERS
#define JAMAICA_JBI_CALL_MODIFIERS
#define JAMAICA_JBI_IMPORT_MODIFIERS
#define JAMAICA_JBI_EXPORT_MODIFIERS*/
...
/*
 * jamaica_ref was a jamaica_block * but we need to index the main memory so it
 * is now the raw (char *) address in RAM of a jamaica_block
 */
...
/*
 * The Jamaica memory structure
 * SIGNIFICANTLY simplified for use on the FPGA. Whilst this looks like it costs more memory
 * (everything is an int), it actually saves memory because Unions do not take up the same
 * space on the FPGA as they do in C, so the Jamaica style of a union for all possible types is about as bad
 * as it could possibly be. Further, the unnecessary top bits will often be optimised away
...
union jamaica_block {
	jamaica_data32 data[JAMAICA_BLOCK_SIZE];
	//jamaica_data64 data64[JAMAICA_BLOCK_SIZE/2];
};
...
//#define JAMAICA_BLOCK_GET_DATA32(b,ix) ((b)->data[ix])
//#define JAMAICA_BLOCK_GET_DATA64(b,ix) ((b)->data64[(ix)/2])
...
#ifdef JAMAICA_CONTIGUOUS_PRIM_ARRAYS
#define JAMAICA_GET_PRIMITIVE_ARRAY_ELEMENTS_ADR(a) (                  (JAMAICA_BLOCK_GET_P(a,JAMAICA_ARRAY_ELEMENTS)))
#else
...
#ifndef JAMAICA_CONTIGUOUS_PRIM_ARRAYS
#define JAMAICA_GET_ARRAY8_D0(b, ix,  result)      result = jamaicaGC_GetArray8_d0   (   b,ix             )
#define JAMAICA_SET_ARRAY8_D0(b, ix,  v)                    jamaicaGC_SetArray8_d0   (   b,ix,v           )
#define JAMAICA_GET_ARRAY16_D0(b,ix,  result)      result = jamaicaGC_GetArray16_d0  (   b,ix             )
#define JAMAICA_SET_ARRAY16_D0(b,ix,  v)                    jamaicaGC_SetArray16_d0  (   b,ix,v           )
#define JAMAICA_GET_ARRAY32_D0(b,ix,  result)      result = jamaicaGC_GetArray32_d0  (   b,ix             )
#define JAMAICA_SET_ARRAY32_D0(b,ix,  v)                    jamaicaGC_SetArray32_d0  (   b,ix,v           )
#define JAMAICA_GET_ARRAY64_D0(b,ix,  result)      result = jamaicaGC_GetArray64_d0  (   b,ix             )
#define JAMAICA_SET_ARRAY64_D0(b,ix,  v)                    jamaicaGC_SetArray64_d0  (   b,ix,v           )
#define JAMAICA_GET_ARRAY_DOUBLE_D0(b,ix,  result) result = jamaicaGC_GetArrayDouble_d0( b,ix             )
#define JAMAICA_SET_ARRAY_DOUBLE_D0(b,ix,  v)               jamaicaGC_SetArrayDouble_d0( b,ix,v           )
#define JAMAICA_GET_ARRAY_FLOAT_D0(b,ix,  result ) result = jamaicaGC_GetArrayFloat_d0 ( b,ix             )
#define JAMAICA_SET_ARRAY_FLOAT_D0(b,ix,  v)                jamaicaGC_SetArrayFloat_d0 ( b,ix,v           )
#endif
#define JAMAICA_GET_ARRAY32REF_D0(b,ix,result)     result = jamaicaGC_GetArray32Ref_d0 (b,ix             )
#define JAMAICA_SET_ARRAY32REF_D0(b,ix,r)                   jamaicaGC_SetArray32Ref_d0 (b,ix,r           )
#define JAMAICA_GET_REF_ARRAY_D0(b,ix,result)      result = jamaicaGC_GetRefArray_d0 (   b,ix             )
#define JAMAICA_SET_REF_ARRAY_D0(ct,b,ix,r)                 jamaicaGC_SetRefArray_d0 (ct,b,ix,r           )
#ifdef JAMAICA_CONTIGUOUS_PRIM_ARRAYS
#define JAMAICA_GET_ARRAY8(b, ix, result)      (result =                   JAMAICA_GET_ARRAY8_ELEMENTS_ADR( b) [ix]     )
#define JAMAICA_SET_ARRAY8(b, ix, v)           (                           JAMAICA_GET_ARRAY8_ELEMENTS_ADR( b) [ix] = v )
#define JAMAICA_GET_ARRAY16(b,ix, result)      (result =                   JAMAICA_GET_ARRAY16_ELEMENTS_ADR(b) [ix]     )
#define JAMAICA_SET_ARRAY16(b,ix, v)           (                           JAMAICA_GET_ARRAY16_ELEMENTS_ADR(b) [ix] = v )
#define JAMAICA_GET_ARRAY32(b,ix, result)      (result =                   JAMAICA_GET_ARRAY32_ELEMENTS_ADR(b) [ix]     )
#define JAMAICA_SET_ARRAY32(b,ix, v)           (                           JAMAICA_GET_ARRAY32_ELEMENTS_ADR(b) [ix] = v )
#define JAMAICA_GET_ARRAY64(b,ix, result)      (result =                   JAMAICA_GET_ARRAY64_ELEMENTS_ADR(b) [ix]     )
#define JAMAICA_SET_ARRAY64(b,ix, v)           (                           JAMAICA_GET_ARRAY64_ELEMENTS_ADR(b) [ix] = v )
#define JAMAICA_GET_ARRAY_FLOAT(b,ix, result)  (result = ((jamaica_float *)JAMAICA_GET_ARRAY32_ELEMENTS_ADR(b))[ix]     )
#define JAMAICA_SET_ARRAY_FLOAT(b,ix, v)       (         ((jamaica_float *)JAMAICA_GET_ARRAY32_ELEMENTS_ADR(b))[ix] = v )
#define JAMAICA_GET_ARRAY_DOUBLE(b,ix, result) (result = ((jamaica_double*)JAMAICA_GET_ARRAY64_ELEMENTS_ADR(b))[ix]     )
#define JAMAICA_SET_ARRAY_DOUBLE(b,ix, v)      (         ((jamaica_double*)JAMAICA_GET_ARRAY64_ELEMENTS_ADR(b))[ix] = v )
