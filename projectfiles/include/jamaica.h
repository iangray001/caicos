...
#define JAMAICA_GET_ARRAYU16(b,ix, result)                  (result = jamaicaGC_GetArray16(b,ix))
#define JAMAICA_SET_ARRAYU16(b,ix, v)                       jamaicaGC_SetArray16(b,ix,v)
...
#define JAMAICA_GET_ARRAYU16_D0(b,ix, result) JAMAICA_GET_ARRAYU16(b,ix, result)
#define JAMAICA_SET_ARRAYU16_D0(b,ix, v) JAMAICA_SET_ARRAYU16(b,ix, v)
