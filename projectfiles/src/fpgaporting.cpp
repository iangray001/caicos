...
jamaica_ref juniper_ram_fetch_r(int addr, int subwordoffset) {return 0;}
jamaica_int32 juniper_ram_fetch_i(int addr, int subwordoffset) {return 0;}
jamaica_uint32 juniper_ram_fetch_ui(int addr, int subwordoffset) {return 0;}
jamaica_int16 juniper_ram_fetch_s(int addr, int subwordoffset) {return 0;}
jamaica_uint16 juniper_ram_fetch_us(int addr, int subwordoffset) {return 0;}
jamaica_int8 juniper_ram_fetch_b(int addr, int subwordoffset) {return 0;}
jamaica_uint8 juniper_ram_fetch_ub(int addr, int subwordoffset) {return 0;}
jamaica_float juniper_ram_fetch_f(int addr, int subwordoffset) {return 0;}
