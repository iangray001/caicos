...
# And dump to ISE
#export_design -format ip_catalog -description "A module for the JUNIPER project" -vendor "york.ac.uk" -version "1.0"
export_design -format syn_dcp -description "A module for the JUNIPER project" -vendor "york.ac.uk" -version "1.0"
